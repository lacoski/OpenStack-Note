# Cấu hình IP
vlan mgnt : eno1: 172.16.4.123
vlan data-vm : ens1f1: 10.10.12.123
vlan provider: eno2: 10.10.11.123
...
# Khai bao file hosts
echo "10.10.10.11 controller" >> /etc/hosts
echo "10.10.10.12 compute01" >> /etc/hosts
...
transport_url = rabbit://openstack:Welcome123@10.10.10.11:5672
use_neutron = True
...
server_proxyclient_address = 10.10.10.13
...
# Truy cập dashboard ở địa chỉ http://10.10.10.11 và tạo máy ảo
